  ...
  const formSignup = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      maNhom: Yup.string()
        ...
        .matches(/^[\w\d]{4,}$/, "Mã nhóm phải có 4 ký tự"),
    }),
    onSubmit: async (value) => {
      try {
        const data = await userService.postSignup({
          ...value,
          maNhom: MA_NHOM,
        });
  ...
  return (
    <div>
      ...
      >
        ...
        <div>
          <label className="text-sm font-medium" htmlFor="soDT">
            Số điện thoại
          </label>
          <input
            id="soDT"
