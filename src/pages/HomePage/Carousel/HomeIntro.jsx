    ...
    <section className="text-gray-600 body-font">
      <div className="container px-2 py-20 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          <div className="p-8 rounded bg-green-500 text-white">
          ...
          <div className="flex flex-col justify-between gap-2">
            <div className="p-8 rounded bg-yellow-500 text-white flex-1">
            ...
            <div className="">
              <div className="p-8 rounded bg-yellow-500 text-white">
          ...
          <div className=" xl:col-span-1 md:col-span-2 gap-2 flex flex-col">
            <div className=" md:col-span-1">
              <div className="p-8 rounded bg-gray-700 text-white">
                ...
                <ul>
                  <li>
                    ...
                    ></i>
                    <span>
                      Tự động chấm điểm trắc nghiệm và đưa câu hỏi tùy theo mức
                      độ học viên
                    </span>
                  </li>
                  <li>
              ...
              <div className="p-8 rounded bg-gray-700 text-white">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    ></i>
                    <span>
                      Kết nối CV của bạn đến với các đối tác của Edumall
                    </span>
                  </li>
                </ul>
              </div>
